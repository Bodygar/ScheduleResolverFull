...
class AiScheduleService extends ChangeNotifier {
  ...
  final String _apiKey = 'AIzaSyA6N7tnnQ4iHQwZqCQWm8sjHqG9tybAnlA';
  ...
  Future<void> analyzeSchedule(List<TaskModel> tasks) async {
    ...
    try {
      ...
      final prompt = '''
        ...
        Your job is to analyze these tasks, identify any overlaps or conflicts in their start and end time suggest a better balanced schedule.
  ...
  ScheduleAnalysis _parseResponse(String fullText){
    ...
    return ScheduleAnalysis(conflicts: conflicts, explanation: explanation, rankedTasks: rankedTasks, recommendedSchedule: recommendedSchedule);
